...
var BASE_CSS = 'padding: 1px; margin:1px; line-height: 1.8em;';
...
function TransportConsole ( options ){
    ...
    this._colorDict = {
        ...
        warn: BASE_CSS + 'padding: 1px; background: #ffff00; color: #343434; font-style: bold; border: 1px solid #cccc00;'
    };
...
TransportConsole.prototype.log = function transportConsoleLog( loggedObject ){
    ...
    // Log it
    // ------------------------------
    window.console.log.apply(window.console, toLogArray);
    ...
    if(metaLogArray.length > 0){
        window.console.log.apply(window.console, metaLogArray);
    }
